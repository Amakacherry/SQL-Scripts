...
/* To see the number of each employee showing only once, You visualise the perion# encompassing the 
# last contract of each employee
# THe Syntax is,
...
/*  A view acts as a shortcut for writing the same SELECT stmtevery time a new
