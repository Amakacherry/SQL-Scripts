...
VALUES('999999', '1999-01-01', 'Amaka', 'Jaja', 'F', '2022-08-04');
...
Then, create an index on the â€˜salaryâ€™ column of that table, and check if it has 
sped up the search of the same SELECT statement.*/

SELECT * FROM SALARIES WHERE salary > 89000;
CREATE INDEX i1_salary ON salaries (salary);
